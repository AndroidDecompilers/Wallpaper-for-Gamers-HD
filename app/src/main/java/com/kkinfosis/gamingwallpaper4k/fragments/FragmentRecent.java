...
public class FragmentRecent extends Fragment {
    ...
    public static ArrayList<RecentItem> arrayListItemCategorys;
    int counter = 1;
    ...
    private class MyTask extends AsyncTask<String, Void, String> {
        protected void onPreExecute() {
            super.onPreExecute();
            FragmentRecent.this.progressBar.setVisibility(0);
        }
...
//                    FragmentRecent.this.databaseHandlerRecent.AddtoFavoriteLatest(new RecentItem(jSONObject.getString("category_name"), jSONObject.getString(JsonConfig.LATEST_IMAGE_URL)));
                    ...
                    FragmentRecent.this.listRecentItem.add(recentItem);
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
            while (i < FragmentRecent.this.listRecentItem.size()) {
                FragmentRecent.this.recentItem = (RecentItem) FragmentRecent.this.listRecentItem.get(i);
                FragmentRecent.this.allListImage.add(FragmentRecent.this.recentItem.getImageurl());
                FragmentRecent.this.allArrayImage = (String[]) FragmentRecent.this.allListImage.toArray(FragmentRecent.this.allArrayImage);
                FragmentRecent.this.allListImageCatName.add(FragmentRecent.this.recentItem.getCategoryName());
            ...
            FragmentRecent.this.arrayListItemCategory.addAll(FragmentRecent.this.listRecentItem);
            arrayListItemCategorys = arrayListItemCategory;
    ...
    class RecyclerTouchListener implements OnItemTouchListener {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            View findChildViewUnder = FragmentRecent.this.recyclerView.findChildViewUnder(motionEvent.getX(), motionEvent.getY());
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), this.recyclerView, new ClickListener() {
            public void onClick(View view, int i) {
                Intent intent = new Intent(FragmentRecent.this.getActivity(), NewActivitySlideImage.class);
                intent.putExtra("POSITION_ID", i);
                intent.putExtra("IMAGE_ARRAY", FragmentRecent.this.allArrayImage);
                intent.putExtra("class", FragmentRecent.class.getSimpleName());
        ...
        this.swipeRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            public void onRefresh() {
                FragmentRecent.this.listRecentItem.clear();
                FragmentRecent.this.allListImage.clear();
                FragmentRecent.this.allListImageCatName.clear();
                recyclerView.getAdapter().notifyDataSetChanged();
                new Handler().postDelayed(new Runnable() {
                    public void run() {
                        if (JsonUtils.isNetworkAvailable(FragmentRecent.this.getActivity())) {
                            FragmentRecent.this.swipeRefreshLayout.setRefreshing(false);
                            FragmentRecent.this.clearData();
                            new MyTask().execute(new String[]{"https://appsapionline.com/wallpapers/recent"});
                            return;
                        }
                        FragmentRecent.this.swipeRefreshLayout.setRefreshing(false);
                        Toast.makeText(FragmentRecent.this.getActivity(), FragmentRecent.this.getResources().getString(R.string.refresh_alert), 0).show();
                    }
                }, 3000);
            }
        });
        ...
        if (this.searchView != null) {
            ...
            this.queryTextListener = new OnQueryTextListener() {
                public boolean onQueryTextChange(String str) {
                    ...
                    FragmentRecent.this.filter(str);
                    return true;
                }
    ...
    public void setAdapterToListView() {
        this.AdapterRecent = new AdapterRecent(getActivity(), this.listRecentItem);
